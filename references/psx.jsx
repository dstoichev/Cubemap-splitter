...
//
// $Id: psx.jsx,v 1.97 2015/09/27 01:17:56 anonymous Exp $
...
ZStrs.IBM =
  localize("$$$/JavaScripts/psx/IBM=IBM");
...
ZStrs.ProfileCanonPro9000 = 
  localize("$$$/Canon/Profile/CanonPro9000=Canon Pro9000 SP4");
...
ZStrs.ProfileUntaggedRGB = 
  localize("$$$/Print/Source/UntaggedRGB=Untagged RGB");
...
//
ZStrs.Automatic = 
  localize("$$$/Menu/ImageSizeInterpolation/Automatic=Automatic");

ZStrs.PreserveDetails = 
  localize("$$$/Actions/Key/deNoise/EdgeFidelity=Preserve Details");

ZStrs.Bicubic = 
  localize("$$$/S4W/Interpolation/Bicubic=Bicubic");

ZStrs.BicubicAutomatic = 
  localize("$$$/Menu/ImageSizeInterpolation/BicubicAutomatic=Bicubic Automatic");

ZStrs.BicubicSharper = 
  localize("$$$/S4W/Interpolation/Sharper=Bicubic Sharper");

ZStrs.BicubicSmoother = 
  localize("$$$/S4W/Interpolation/Smoother=Bicubic Smoother");

ZStrs.MenuNone = 
  localize("$$$/AdobePlugin/Shared/None=None");

ZStrs.Bilinear = 
  localize("$$$/Menu/ImageSizeInterpolation/Bilinear=Bilinear");

ZStrs.NearestNeighbor =
  localize("$$$/S4W/Interpolation/Nearest=Nearest Neighbor");
...
ZStrs.FileTypeLbl =
  localize("$$$/JavaScripts/ImageProcessor/FileType=File Type:");

ZStrs.SaveForWeb =
  localize("$$$/Actions/Enum/SaveForWeb=Save for Web");

ZStrs.FlattenImage =
  localize("$$$/Actions/Event/FlattenImage=Flatten Image");

ZStrs.RLECompression =
  localize("$$$/AdobePlugin/Targa/RLECompression=RLE Compression");

ZStrs.BitDepthLbl =
  localize("$$$/JavaScripts/ContactSheet2/BitDepthLabel=Bit Depth:");

ZStrs.SaveOptions = 
  localize("$$$/Windows/SaveCopy/SaveOptions=Save Options");

ZStrs.Bridge = 
  localize("$$$/AETE/ContactSheet2/Bridge=Bridge");

ZStrs.UnknownFiletype = 
  localize("$$$/ErrorStrings/UnknownFiletype=because Photoshop does not recognize this type of file");

ZStrs.CouldNoteCompleteCommand = 
  localize("$$$/Messages/GenericCommand=Could not complete the command ^0.", "");

ZStrs.SameAsSource = 
  localize("$$$/JavaScripts/psx/FilesType/SameAsSource=Same as Source");

ZStrs.Bitmap = 
  localize("$$$/Actions/Enum/Bitmap=Bitmap");

ZStrs.BitmapBMP = 
  localize("$$$/Actions/Enum/Bitmap=Bitmap") + ' ' +
  localize("$$$/AdobePlugin/PIPLInfo/PluginName/BMP=BMP");

ZStrs.GIF = 
  localize("$$$/FileTypes/GIF=GIF");

ZStrs.JPEG = 
  localize("$$$/FileTypes/JPEG=JPEG");

ZStrs.PhotoshopPSD = 
  localize("$$$/JavaScripts/psx/PhotoshopPSD=Photoshop PSD");

ZStrs.PhotoshopEPS = 
  localize("$$$/Formats/EPS/Name=Photoshop EPS");

ZStrs.PhotoshopPDF = 
  localize("$$$/Formats/PDF/Name=Photoshop PDF");

ZStrs.PNG = 
  localize("$$$/Format/PNG=PNG");

ZStrs.Targa = 
  localize("$$$/AdobePlugin/PIPLInfo/PluginName/Targa=Targa");

ZStrs.TIFF = 
  localize("$$$/Formats/TIFF/ReadAll/Name=TIFF");

ZStrs.AlphaChannels = 
  localize("$$$/NavServicesSaveDialog/Alpha=Alpha Channels");

ZStrs.Transparency = 
  localize("$$$/Actions/Key/SaveTransparency=Transparency");

ZStrs.Interlaced = 
  localize("$$$/S4W/Dialog/GIF/Interlaced/Check=Interlaced");

ZStrs.ColorsLbl = 
  localize("$$$/S4W/Dialog/PNG8/Colors/Edit=Colors:");

ZStrs.QualityLbl = 
  localize("$$$/JavaScripts/ImageProcessor/Quality=Quality:");

ZStrs.EmbedProfile = 
  localize("$$$/SaveDialog/Mac/EmbedProfile=Embed Color Profile");

ZStrs.FormatLbl = 
  localize("$$$/NavServicesSaveDialog/Format=Format:");

ZStrs.Standard = 
  localize("$$$/JavaScripts/psx/JPEGFormat/Standard=Standard");

ZStrs.Progressive = 
  localize("$$$/Dialog/JPEGFormat/Progressive=Progressive");

ZStrs.Optimized = 
  localize("$$$/JavaScripts/psx/JPEGFormat/Optimized=Optimized");

ZStrs.ConvertToSRGB = 
  localize("$$$/S4W/Dialog/Settings/ColorManage/Check=Convert to sRGB");
            
ZStrs.SaveLayers = 
  localize("$$$/NavServicesSaveDialog/SaveLayers=Layers");

ZStrs.MaximizeCompatibility = 
  localize("$$$/Actions/Key/maximizeCompatibility=Maximize Compatibility");

ZStrs.EncodingLbl = 
  localize("$$$/Menu/EPSEncoding=Encoding:");

ZStrs.ASCII = 
  localize("$$$/Menu/EPSEncoding/ASCII=ASCII");

ZStrs.Binary = 
  localize("$$$/Menu/EPSEncoding/Binary=Binary");

ZStrs.JPEGHigh = 
  localize("$$$/FileName/Presets/OptimizedSettings/JPEGHigh=JPEG High");

ZStrs.JPEGLow = 
  localize("$$$/FileName/Presets/OptimizedSettings/JPEGLow=JPEG Low");

ZStrs.JPEGMax = 
  localize("$$$/JavaScripts/psx/JPEGMax=JPEG Max");
            
ZStrs.JPEGMed = 
  localize("$$$/JavaScripts/psx/JPEGMed=JPEG Med");

ZStrs.LZW = 
  localize("$$$/JavaScripts/psx/LZW=LZW");

ZStrs.ZIP = 
  localize("$$$/JavaScripts/psx/ZIP=ZIP");
...
ZStrs.ByteOrderLbl = 
  localize("$$$/Dialog/TIFFFormat/ByteOrder=Byte Order")+ ':';

ZStrs.FNName = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/MixedName=Name");

ZStrs.FNNameExample =
  localize("$$$/JavaScripts/psx/FileNamingMenu/MixedName/Example=Document");

ZStrs.FNLCName = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/LCName=name");

ZStrs.FNLCNameExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/LCName/Example=document");

ZStrs.FNUCName = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/UCName=NAME");

ZStrs.FNUCNameExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/UCName/Example=DOCUMENT");

ZStrs.FN1Serial = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial1=Serial #");

ZStrs.FN1SerialExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial1/Example=1");

ZStrs.FN2Serial = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial2=Serial ##");

ZStrs.FN2SerialExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial2/Example=01");

ZStrs.FN3Serial = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial3=Serial ###");

ZStrs.FN3SerialExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial3/Example=001");

ZStrs.FN4Serial = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial4=Serial ####");

ZStrs.FN4SerialExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial4/Example=0001");

ZStrs.FN5Serial = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial5=Serial #####");

ZStrs.FN5SerialExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Serial5/Example=00001");

ZStrs.FNSerialLetterLower = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/SerialLetterLower=Serial a");

ZStrs.FNSerialLetterLowerExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/SerialLetterLower/Example=a");

ZStrs.FNSerialLetterUpper = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/SerialLetterUpper=Serial A");

ZStrs.FNSerialLetterUpperExample =
  localize("$$$/JavaScripts/psx/FileNamingMenu/SerialLetterUpper/Example=A");

ZStrs.FNDate_mmddyy =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_mmddyy=mmddyy");

ZStrs.FNDate_mmddyyExample =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_mmddyy/Example=103107");

ZStrs.FNDate_mmdd =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_mmdd=mmdd");

ZStrs.FNDate_mmddExample =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_mmdd/Example=1031");

ZStrs.FNDate_yyyymmdd =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yyyymmdd=yyyymmdd");

ZStrs.FNDate_yyyymmddExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yyyymmdd/Example=20071031");

ZStrs.FNDate_yymmdd =
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yymmdd=yymmdd");

ZStrs.FNDate_yyymmddExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yymmdd/Example=071031");

ZStrs.FNDate_yyddmm = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yyddmm=yyddmm");

ZStrs.FNDate_yyddmmExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_yyddmm/Example=073110");

ZStrs.FNDate_ddmmyy = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_ddmmyy=ddmmyy");

ZStrs.FNDate_ddmmyyExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_ddmmyy/Example=311007");

ZStrs.FNDate_ddmm = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_ddmm=ddmm");

ZStrs.FNDate_ddmmExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/Date_ddmm/Example=1031");

ZStrs.FNLCExtension = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/FNLCExtension=ext");

ZStrs.FNLCExtensionExample = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/FNLCExtension/Example=.psd");

ZStrs.FNUCExtension = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/FNUCExtension=EXT");

ZStrs.FNUCExtension = 
  localize("$$$/JavaScripts/psx/FileNamingMenu/FNUCExtension/Example=.PSD");

ZStrs.MenuCreate =
  localize("$$$/Menu/Default/CreatePanel=Create");

ZStrs.MenuEdit =
  localize("$$$/S4W/EditMenu/Title=Edit");

ZStrs.MenuDelete =
  localize("$$$/Actions/Event/Delete=Delete");

ZStrs.FilePanelColumnError = 
  localize("$$$/Messages/GenericCommand=Could not complete the command ^0.",
           "FileName Panel column spec");
  
ZStrs.FPNoNameError = 
  localize("$$$/JavaScripts/psx/NoNameError=You must specify a name for the files.");

ZStrs.None =
  localize("$$$/Actions/Enum/FileNamingComponent/none=None");
...
psx.PSVersion = Number(app.version.match(/^\d+/)[0]);
...
//
// Function: getByName
// Description: find an item (or items) called 'name' from the specified
// container.
// This works for the "magic" PS containers like Documents.getByName(),
// for instance. However this returns null if an index is not found instead
// of throwing an exception.
// Input: the 'container', the 'name' of the object as a string or a RegExp,
// and an optional 'all' boolean indicating that all matches should be returned
// Return: one or more elements with the desired name or null if none are found
//
psx.getByName = function(container, name, all) {
  // check for a bad index
  if (!name) {
...
//
// Function: getByProperty
// Description: find an item (or items) who was a property matches a desired
// value from the specified container. This works for the "magic" PS containers
// as well as Arrays. However this returns null if an index is not found
// instead of throwing an exception.
// Input: the 'container', 'prop' is the name of property, 'value' as the
// desired value or a RegExp, and an optional 'all' boolean indicating that
// all matches should be returned
// Return: one or more elements with the value of the desired property or
...
// Description: find an item (or items) for which the specified function 
// returns 'true'. This works for the "magic" PS containers as well as 
// Arrays instance. However this returns null if an index is not found
// instead of throwing an exception.
// Input: the 'container', 'prop' is the name of property, 'value' as the
// desired value or a RegExp, and an optional 'all' boolean indicating that
// all matches should be returned
...
// null if none are found
//
psx.getByFunction = function(container, matchFtn, all) {
...
ColorProfileNames.PRO9000SP4     = "Canon Pro9000 SP4";
ColorProfileNames.LAB            = "Lab";
ColorProfileNames.WORKING_CMYK   = "Working CMYK";
ColorProfileNames.WORKING_GRAY   = "Working GRAY";
ColorProfileNames.WORKING_RGB    = "Working RGB";
ColorProfileNames.UNTAGGED_RGB   = "Untagged RGB";
...
psx.delocalizeProfile = function(profile) {
  ...
  switch (profile) {
    ...
    case ZStrs.ProfileCanonPro9000:  p = ColorProfileNames.PRO9000SP4; break;

    case ZStrs.ProfileLab:           p = ColorProfileNames.LAB; break;
    case ZStrs.ProfileWorkingCMYK:   p = ColorProfileNames.WORKING_CMYK; break;
    case ZStrs.ProfileWorkingGray:   p = ColorProfileNames.WORKING_GRAY; break;
    case ZStrs.ProfileWorkingRGB:    p = ColorProfileNames.WORKING_RGB; break;
    case ZStrs.ProfileUntaggedRGB:   p = ColorProfileNames.UNTAGGED_RGB; break;
  }
...
// Description: converts a standard color profile name to localized
//              profile name
// Input:  profile - standard color profile name
// Return: a localized color profile name
//
psx.localizeProfile = function(profile) {
  var p = profile;

  switch (profile) {
    case ColorProfileNames.ADOBE_RGB:      p = ZStrs.ProfileAdobeRGB; break;
    case ColorProfileNames.APPLE_RGB:      p = ZStrs.ProfileAppleRGB; break;
    case ColorProfileNames.PROPHOTO_RGB:   p = ZStrs.ProfileProPhotoRGB; break;
    case ColorProfileNames.SRGB:           p = ZStrs.ProfileSRGB; break;
    case ColorProfileNames.COLORMATCH_RGB: p = ZStrs.ProfileColorMatchRGB; break;
    case ColorProfileNames.WIDEGAMUT_RGB:  p = ZStrs.ProfileWideGamutRGB; break;
    case ColorProfileNames.PRO9000SP4:     p = ZStrs.ProfileCanonPro9000; break;

    case ColorProfileNames.LAB:            p = ZStrs.ProfileLab; break;
    case ColorProfileNames.WORKING_CMYK:   p = ZStrs.ProfileWorkingCMYK; break;
    case ColorProfileNames.WORKING_GRAY:   p = ZStrs.ProfileWorkingGray; break;
    case ColorProfileNames.WORKING_RGB:    p = ZStrs.ProfileWorkingRGB; break;
    case ColorProfileNames.UNTAGGED_RGB:   p = ZStrs.ProfileUntaggedRGB; break;
  }

  return p;
};

psx.localizeTIFFEncoding = function(encoding) {
  var e = encoding;

  switch (encoding) {
    case TIFFEncoding.JPEG:     e = ZStrs.JPEG; break;
    case TIFFEncoding.NONE:     e = ZStrs.None; break;
    case TIFFEncoding.TIFFLZW:  e = ZStrs.LZW; break;
    case TIFFEncoding.TIFFZIP:  e = ZStrs.ZIP; break;
  }

  return e;
};

psx.delocalizeTIFFEncoding = function(str) {
  var e = TIFFEncoding.NONE;

  switch (str) {
    case ZStrs.JPEG: e = TIFFEncoding.JPEG; break;
    case ZStrs.None: e = TIFFEncoding.NONE; break;
    case ZStrs.LZW:  e = TIFFEncoding.TIFFLZW; break;
    case ZStrs.ZIP:  e = TIFFEncoding.TIFFZIP; break;
  }
...
// Input:  pnl - Panel
//         str - Array of UI strings
// Return: int
//
psxui.strWidth = function(pnl, str) {
  return pnl.graphics.measureString(str)[0];
};
...
FileSaveOptions.convert = function(fsOpts) {
  ...
  switch (fsType) {
    ...
    case "tif": {
      ...
      var str = _toString(fsOpts.tiffEncoding).toLowerCase();
      
      if (str.match(/none/)) {
        value = TIFFEncoding.NONE;
      } else if (str.match(/lzw/)) {
        value = TIFFEncoding.TIFFLZW;
      } else if (str.match(/zip/)) {
        value = TIFFEncoding.TIFFZIP;
      } else if (str.match(/jpg|jpeg/)) {
    ...
    default: {
      Error.runtimeError(9001, ZStrs.CouldNoteCompleteCommand + " " +
                         ZStrs.UnknownFiletype + " " +
                         fs.fileType);
    }
  }
...
FileSaveOptionsTypes._init = function() {
  ...
  if (FileSaveOptions._enableSAS) {
    FileSaveOptionsTypes._add("SaS", ZStrs.SameAsSource, undefined, undefined);
  }

  FileSaveOptionsTypes._add("bmp", ZStrs.BitmapBMP, SaveDocumentType.BMP,
                            BMPSaveOptions);
  FileSaveOptionsTypes._add("gif", ZStrs.GIF, SaveDocumentType.COMPUSERVEGIF,
                            GIFSaveOptions);
  FileSaveOptionsTypes._add("jpg", ZStrs.JPEG, SaveDocumentType.JPEG,
                            JPEGSaveOptions);
  FileSaveOptionsTypes._add("psd", ZStrs.PhotoshopPSD,
                            SaveDocumentType.PHOTOSHOP,
                            PhotoshopSaveOptions);
  FileSaveOptionsTypes._add("eps", ZStrs.PhotoshopEPS,
                            SaveDocumentType.PHOTOSHOPEPS, EPSSaveOptions);
  FileSaveOptionsTypes._add("pdf", ZStrs.PhotoshopPDF,
                            SaveDocumentType.PHOTOSHOPPDF, PDFSaveOptions);
  FileSaveOptionsTypes._add("png", ZStrs.PNG, SaveDocumentType.PNG,
                            PNGSaveOptions);
  FileSaveOptionsTypes._add("tga", ZStrs.Targa, SaveDocumentType.TARGA,
                            TargaSaveOptions);
  FileSaveOptionsTypes._add("tif", ZStrs.TIFF, SaveDocumentType.TIFF,
                            TiffSaveOptions);
...
FileSaveOptions.createFileSavePanel = function(pnl, ini) {
  ...
  pnl.text = ZStrs.SaveOptions;

  var tOfs = 3;

  var wFileType = Math.max(60, psxui.strWidth(pnl, ZStrs.FileTypeLbl));
  var x = xofs;
  var w = pnl.add('statictext', [x,y+tOfs,x+wFileType,y+22+tOfs],
                  ZStrs.FileTypeLbl);
  ...
  pnl.saveForWeb = pnl.add('checkbox', [x,y,x+135,y+22], ZStrs.SaveForWeb);
  pnl.saveForWeb.visible = false;
  pnl.saveForWeb.value = false;
  pnl.flattenImage = pnl.add('checkbox', [x,y,x+135,y+22], ZStrs.FlattenImage);
  ...
  var wEmbedProfile = Math.max(155, psxui.strWidth(pnl, ZStrs.EmbedProfile)+5);
  ...
  if (FileSaveOptionsTypes["bmp"]) {
    ...
    pnl.bmpDepthLabel = pnl.add('statictext', [x,y+tOfs,x+70,y+22+tOfs],
                                ZStrs.BitDepthLbl);
    x += 75;
  ...
  if (FileSaveOptionsTypes["jpg"]) {
    ...
    y += 30;
    x = xofs;
    pnl.jpgEmbedColorProfile = pnl.add('checkbox', [x,y,x+wEmbedProfile,y+22],
                                       ZStrs.EmbedProfile);

    y = yofs;
    x += wEmbedProfile + 5;

    var jpgFormatMenu = [ZStrs.Standard, ZStrs.Progressive, ZStrs.Optimized];
    ...
    pnl.jpgFormat.selection = pnl.jpgFormat.find(ZStrs.Standard);

    pnl.jpgFormat.find(ZStrs.Standard)._value = FormatOptions.STANDARDBASELINE;
    pnl.jpgFormat.find(ZStrs.Progressive)._value = FormatOptions.PROGRESSIVE;
    pnl.jpgFormat.find(ZStrs.Optimized)._value = FormatOptions.OPTIMIZEDBASELINE;
  ...
  if (FileSaveOptionsTypes["psd"]) {
    ...
    y += 30;
    pnl.psdEmbedColorProfile = pnl.add('checkbox', [x,y,x+wEmbedProfile,y+22],
                                       ZStrs.EmbedProfile);

    y = yofs;
    x = xofs + wEmbedProfile + 10;

    pnl.psdLayers = pnl.add('checkbox', [x,y,x+95,y+22],
                            ZStrs.SaveLayers);

    x += 95;
    var psdBPCMenu = ["1", "8", "16", "32"];
    pnl.psdBPCLabel = pnl.add('statictext', [x,y+tOfs,x+70,y+22+tOfs],
                              ZStrs.BitDepthLbl);
    x += 75;
  ...
  if (FileSaveOptionsTypes["eps"]) {
    var epsEncodingMenu = [ZStrs.ASCII, ZStrs.Binary, ZStrs.JPEGHigh,
                           ZStrs.JPEGMed, ZStrs.JPEGLow, ZStrs.JPEGMax];
    pnl.epsEncodingLabel = pnl.add('statictext', [x,y+tOfs,x+65,y+22+tOfs],
                                   ZStrs.EncodingLbl);
    x += 70;
    pnl.epsEncoding = pnl.add('dropdownlist',
                              [x,y,x+100,y+22],
                              epsEncodingMenu);
    pnl.epsEncoding.selection = pnl.epsEncoding.find(ZStrs.Binary);

    pnl.epsEncoding.find(ZStrs.ASCII)._value = SaveEncoding.ASCII;
    pnl.epsEncoding.find(ZStrs.Binary)._value = SaveEncoding.BINARY;
    pnl.epsEncoding.find(ZStrs.JPEGHigh)._value = SaveEncoding.JPEGHIGH;
    pnl.epsEncoding.find(ZStrs.JPEGLow)._value = SaveEncoding.JPEGLOW;
    pnl.epsEncoding.find(ZStrs.JPEGMax)._value = SaveEncoding.JPEGMAXIMUM;
    pnl.epsEncoding.find(ZStrs.JPEGMed)._value = SaveEncoding.JPEGMEDIUM;

    x = xofs;
    y += 30;
    pnl.epsEmbedColorProfile = pnl.add('checkbox', [x,y,x+wEmbedProfile,y+22],
                                       ZStrs.EmbedProfile);
  ...
  if (FileSaveOptionsTypes["pdf"]) {
    ...
    x = xofs;
    y += 30;
    pnl.pdfEmbedColorProfile = pnl.add('checkbox', [x,y,x+wEmbedProfile,y+22],
                                       ZStrs.EmbedProfile);
  ...
  if (FileSaveOptionsTypes["tga"]) {
    ...
    pnl.tgaDepthLabel = pnl.add('statictext', [x,y+tOfs,x+70,y+22+tOfs],
                                ZStrs.BitDepthLbl);
    x += 75;
  ...
  if (FileSaveOptionsTypes["tif"]) {
    var wEncoding = Math.max(65, psxui.strWidth(pnl, ZStrs.EncodingLbl));
    var tiffEncodingMenu = [ZStrs.MenuNone, ZStrs.LZW, ZStrs.ZIP, ZStrs.JPEG];
    pnl.tiffEncodingLabel = pnl.add('statictext',
                                    [x,y+tOfs,x+wEncoding,y+22+tOfs],
                                    ZStrs.EncodingLbl);
    x += wEncoding;
    pnl.tiffEncoding = pnl.add('dropdownlist', [x,y,x+75,y+22],
                               tiffEncodingMenu);
    pnl.tiffEncoding.selection = pnl.tiffEncoding.find(ZStrs.MenuNone);

    pnl.tiffEncoding.find(ZStrs.MenuNone)._value = TIFFEncoding.NONE;
    pnl.tiffEncoding.find(ZStrs.LZW)._value = TIFFEncoding.TIFFLZW;
    pnl.tiffEncoding.find(ZStrs.ZIP)._value = TIFFEncoding.TIFFZIP;
    pnl.tiffEncoding.find(ZStrs.JPEG)._value = TIFFEncoding.JPEG;

    x += 90;

    var tiffByteOrderMenu = [ZStrs.IBM, ZStrs.MacOS];
    pnl.tiffByteOrderLabel = pnl.add('statictext', [x,y+tOfs,x+70,y+22+tOfs],
                                     ZStrs.ByteOrderLbl);
    x += 75;
    pnl.tiffByteOrder = pnl.add('dropdownlist', [x,y,x+85,y+22],
                                tiffByteOrderMenu);
    var bo = (isWindows() ? ZStrs.IBM : ZStrs.MacOS);
    pnl.tiffByteOrder.selection = pnl.tiffByteOrder.find(bo);

    pnl.tiffByteOrder.find(ZStrs.IBM)._value = ByteOrder.IBM;
    pnl.tiffByteOrder.find(ZStrs.MacOS)._value = ByteOrder.MACOS;

    x = xofs;
    y += 30;
    pnl.tiffEmbedColorProfile = pnl.add('checkbox', [x,y,x+wEmbedProfile,y+22],
                                        ZStrs.EmbedProfile);
    ...
    var str = psx.localizeTIFFEncoding(opts.tiffEncoding);

    var it = pnl.tiffEncoding.find(str);
    if (it) {
  ...
  for (var i = 0; i < parts.length; i++) {
    ...
    switch (fnel.type) {
      ...
      case FileNamingElement.SERIALNUMBER5:
        ...
        hasSerial = true;
        break;
      case FileNamingType.EXTENSIONLOWER:    s = '.' + ext.toLowerCase();
        hasExtension = true;
        break;
      case FileNamingType.EXTENSIONUPPER:    s = '.' + ext.toUpperCase();
        hasExtension = true;
        break;
...
FileNamingElement.NONE = '(' + ZStrs.None + ')';
...
FileNamingOptions.CUSTOM_TEXT_CREATE = ZStrs.MenuCreate;
FileNamingOptions.CUSTOM_TEXT_DELETE = ZStrs.MenuDelete;
FileNamingOptions.CUSTOM_TEXT_EDIT   = ZStrs.MenuEdit;
...
FileNamingOptions.createFileNamingPanel = function(pnl, ini,
  ...
  if (columns == undefined) {
    ...
    if (columns != 2 && columns != 3) {
      Error.runtimeError(9001, ZStrs.FilePanelColumnError);
    }
  }
...
//     ZStrs.DeleteCustomText,
  ...
  if (useSerial) {
    pnl.startingSerialLbl = pnl.add('statictext', [x,y+tOfs,x+50,y+22+tOfs],
                                    ZStrs.StartingSerialNumber);
    x += 90;
...
FileNamingOptions.validateFileNamingPanel = function(pnl, opts) {
  ...
  if (fopts.fileNaming.length == 0) {
    return self.errorPrompt(ZStrs.FPNoNameError);
  }
...
psxui.getCurrentScreen = function() {
  var screens = $.screens;
